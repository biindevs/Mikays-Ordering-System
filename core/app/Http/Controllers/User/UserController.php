...
class UserController extends Controller
{
    ...
    public function profileupdate(Request $request)
    {
        ...
        $request->validate([
            ...
            'state.required' => 'The Province field is required.',
            'address.required' => 'The Landmark field is required.',
            'country.required' => 'The Barangay field is required.'
        ]);
    ...
    public function shippingupdate(Request $request)
    {
        $request->validate([
            ...
            'shpping_country_code' => 'required'

        ], ['shpping_fname.required' => 'The First Name field is required.',
            'shpping_lname.required' => 'The Last Name field is required.',
            'number.required' => 'The Phone field is required.',
            'shpping_city.required' => 'The City field is required.',
            'shpping_state.required' => 'The Province field is required.',
            'shpping_address.required' => 'Landmark field is required.',
            'shpping_country.required' => 'Barangay field is required.'
        ]);


        Auth::user()->update($request->except('shpping_country_code') + [
            'shipping_country_code' => $request->shpping_country_code
        ]);
    ...
    public function billingdetails()
    {
        ...
        return view('user.billing_details', compact('user', 'ccodes'));
    }
    ...
    public function billingupdate(Request $request)
    {
        ...
        ], ['billing_fname.required' => 'The First Name field is required.',
            'billing_lname.required' => 'The Last Name field is required.',
            'number.billing_number' => 'The Phone field is required.',
            'billing_city.required' => 'The City field is required.',
            'billing_state.required' => 'The Province field is required.',
            'billing_address.required' => 'The Landmark field is required.',
            'billing_country.required' => 'The Barangay field is required.'
        ]);
