...
<div class="sidebar sidebar-style-2" data-background-color="dark2">
    <div class="sidebar-wrapper scrollbar scrollbar-inner">
        <div class="sidebar-content">
            ...
            @elseif(request()->path() == 'admin/pos/payment-methods') show @endif" id="pos">
            ...
            @elseif(request()->is('admin/product/order/delivery')) active
            @elseif(request()->is('admin/product/order/delivery/*')) active @endif">
            ...
            @elseif(request()->is('admin/product/order/delivery')) show
            @elseif(request()->is('admin/product/order/delivery/*')) show @endif" id="orderManagement">
                        ...
                        <ul class="nav nav-collapse">
                            ...
                            <li class="
                            @if (request()->is('admin/product/order/delivery')) active
                            @elseif(request()->is('admin/product/order/delivery/*')) active @endif">
                ...
                <li class="nav-item
                    ...
                    <div class="collapse
                        ...
                        @elseif(request()->is('admin/product/*/edit')) show @endif" id="category">
                        <ul class="nav nav-collapse">
                            <li class="
                @if (request()->path() == 'admin/category') active
        ...
        @elseif(request()->path() == 'admin/offline/gateways') show @endif" id="gateways">
                        <ul class="nav nav-collapse">
                ...
                @if (empty($admin->role) || (!empty($permissions) && in_array('Announcement Popup', $permissions)))
                    <li class="nav-item
                        ...
                        <div class="collapse
                            ...
                            @elseif(request()->is('admin/popup/*/edit')) show @endif" id="announcementPopup">
                            <ul class="nav nav-collapse">
                ...
                @if (empty($admin->role) || (!empty($permissions) && in_array('Push Notification', $permissions)))
                    ...
                    <li class="nav-item
                        ...
                        <div class="collapse
                            ...
                            @elseif(request()->path() == 'admin/pushnotification/send') show @endif" id="pushNotification">
                            <ul class="nav nav-collapse">
                ...
                @if (empty($admin->role) || (!empty($permissions) && in_array('Customers', $permissions)))
                    <li class="nav-item
                        ...
                        <div class="collapse
                                ...
                                @elseif(request()->routeIs('register.user.changePass')) show @endif" id="customers">
                            <ul class="nav nav-collapse">
                ...
                {{-- Subscribers --}}
                    <li class="nav-item
                        ...
                        <div class="collapse
                            ...
                            @elseif(request()->path() == 'admin/mailsubscriber') show @endif" id="subscribers">
                            <ul class="nav nav-collapse">
                ...
                @if (empty($admin->role) || (!empty($permissions) && in_array('Sales Report', $permissions)))
                {{-- Sales Report --}}
                    <li class="nav-item
                        @if (request()->path() == 'admin/sales-report') active @endif">
                ...
                {{-- Admins Management --}}
                    <li class="nav-item
                        ...
                        <div class="collapse
                            ...
                            @elseif(request()->is('admin/user/*/edit')) show @endif" id="adminsManagement">
                            <ul class="nav nav-collapse">
                                <li class="
                                    @if (request()->path() == 'admin/roles') active
                ...
                @if (empty($admin->role) || (!empty($permissions) && in_array('Basic Settings', $permissions)))
                    ...
                    <li class="nav-item
                        ...
                        @elseif(request()->routeIs('admin.email.editTemplate')) show @endif" id="basic">
                            <ul class="nav nav-collapse">
                                <li class="submenu">
