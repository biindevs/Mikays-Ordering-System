                ...
                <div class="selectgroup selectgroup-pills mt-2">
                  ...
                  <label class="selectgroup-item">
                    <input type="checkbox" name="permissions[]" value="POS" class="selectgroup-input"
                      @if(is_array($permissions) && in_array('POS', $permissions)) checked @endif>
                  ...
                  <label class="selectgroup-item">
                    <input type="checkbox" name="permissions[]" value="Order Management" class="selectgroup-input"
                      @if(is_array($permissions) && in_array('Order Management', $permissions)) checked @endif>
                    <span class="selectgroup-button">Order Management</span>
                  </label>
                  <label class="selectgroup-item">
                    <input type="checkbox" name="permissions[]" value="Customers" class="selectgroup-input"
                      @if(is_array($permissions) && in_array('Customers', $permissions)) checked @endif>
                    <span class="selectgroup-button">Customers</span>
                  </label>

                  <label class="selectgroup-item">
                    <input type="checkbox" name="permissions[]" value="Product Management" class="selectgroup-input"
                      @if(is_array($permissions) && in_array('Product Management', $permissions)) checked @endif>
                    <span class="selectgroup-button">Menu Management</span>
                  </label>

                  {{-- <label class="selectgroup-item">
                    <input type="checkbox" name="permissions[]" value="QR Code Builder" class="selectgroup-input"
                      @if(is_array($permissions) && in_array('QR Code Builder', $permissions)) checked @endif>
                  ...
                  {{-- <label class="selectgroup-item">
                    <input type="checkbox" name="permissions[]" value="Reservation Settings" class="selectgroup-input"
                      @if(is_array($permissions) && in_array('Reservation Settings', $permissions)) checked @endif>
                    <span class="selectgroup-button">Reservation Settings</span>
                  </label>

                  <label class="selectgroup-item">
                    <input type="checkbox" name="permissions[]" value="Table Reservation" class="selectgroup-input"
                      @if(is_array($permissions) && in_array('Table Reservation', $permissions)) checked @endif>
                  ...
                  <label class="selectgroup-item">
                    <input type="checkbox" name="permissions[]" value="Website Pages" class="selectgroup-input"
                      @if(is_array($permissions) && in_array('Website Pages', $permissions)) checked @endif>
                  ...
                  <label class="selectgroup-item">
                    <input type="checkbox" name="permissions[]" value="Basic Settings" class="selectgroup-input"
                      @if(is_array($permissions) && in_array('Basic Settings', $permissions)) checked @endif>
                    <span class="selectgroup-button">Settings</span>
                  </label>

                  {{-- <label class="selectgroup-item">
                    <input type="checkbox" name="permissions[]" value="Language Management" class="selectgroup-input"
                      @if(is_array($permissions) && in_array('Language Management', $permissions)) checked @endif>
                  ...
                  <label class="selectgroup-item">
                    <input type="checkbox" name="permissions[]" value="Backup" class="selectgroup-input"
                      @if(is_array($permissions) && in_array('Backup', $permissions)) checked @endif>
                    <span class="selectgroup-button">Database Backup</span>
                  </label>
                  
                  <label class="selectgroup-item">
                    <input type="checkbox" name="permissions[]" value="Sales Report" class="selectgroup-input"
                      @if(is_array($permissions) && in_array('Sales Report', $permissions)) checked @endif>
                    <span class="selectgroup-button">Sales Report</span>
                  </label>
                </div>
              </div>
            </form>
