        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="card-title d-inline-block">Edit Dish</div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="title" placeholder="Enter Dish Name"
                                                value="{{ $data->title }}">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control ltr" name="current_price"
                                                value="{{ $data->current_price }}" placeholder="Enter Current Price" min="1" pattern="[1-9]\d*">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control ltr" name="previous_price"
                                                value="{{ $data->previous_price }}" placeholder="Enter Previous Price" min="1" pattern="[1-9]\d*">
                                        ...
                                        <div class="col-lg-11 p-0">
                                            <div class="form-group">
                                                ...
                                                <input name="variant_names[]" type="text" class="form-control"
                                                    placeholder="eg. Short Orders, Food Trays" v-model="variant.name">
                                            </div>
                                        </div>
                                        <div class="col-lg-1">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input :name="variant.name + '_names' + '[]'" type="text"
                                                            class="form-control"
                                                            placeholder="eg. Short Orders, Food Trays"
                                                            v-model="option.name">
                                                    </div>
                                                </div>
                                                <div class="col-lg-5">
