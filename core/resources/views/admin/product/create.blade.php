        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="card-title d-inline-block">Add Dish</div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control ltr" name="current_price" value=""
                                                placeholder="Enter Current Price" min="1" pattern="[1-9]\d*">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control ltr" name="previous_price" value=""
                                                placeholder="Enter Previous Price" min="1" pattern="[1-9]\d*">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                            ...
                                                            <input :name="variant.name + '_names' + '[]'" type="text" class="form-control"
                                                                    placeholder="eg. Short Orders, Food Trays" v-model="option.name">
                                                    </div>
                                                    </div>
                                                    <div class="col-lg-5">
                                                        <div class="form-group">
