            ...
            <div class="row no-gutters">
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="value" value="" placeholder="Enter value" autocomplete="off" min="1">
            ...
            <div class="row no-gutters">
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="minimum_spend" value="" placeholder="Enter minimum spend" autocomplete="off" min="1">
                        <p class="mb-0 text-warning">If you do not wish to have a minimum spend limit, please leave this field blank.</p>
