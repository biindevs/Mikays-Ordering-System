        ...
        <div class="modal-body">
          <form action="{{route('admin.timeframe.store')}}" id="ajaxForm" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="number" name="max_orders" class="form-control" autocomplete="off" value="" min="1">
                <p class="mb-0 text-danger em" id="errmax_orders"></p>
                <p class="text-warning mb-0">Please indicate the maximum quantity of orders that the restaurant can fulfill within this particular time frame.</p><br>
                <p class="text-warning mb-0">Leave blank for unlimited orders.</p>
            </div>
          </form>
        </div>
