...
{{-- <div class="row">
  <div class="col-12">
    <div class="card">
      ...
      <form class="" action="{{route('admin.slider.image.update', $lang_id)}}" method="post"
            ...
            <div class="col-lg-6">
              <div class="form-group">
                ...
                <div class="showImage mb-3">
                  ...
                  @endif
                  <img
                    src="{{ !empty($abe->slider_shape_img) ? asset('assets/front/img/'.$abe->slider_shape_img) : asset('assets/admin/img/noimage.jpg')}}"
            ...
            <div class="col-lg-6">
              <div class="form-group">
                ...
                <div class="showImage mb-3">
                  ...
                  @endif
                  <img
                    src="{{ $abe->slider_bottom_img ? asset('assets/front/img/'.$abe->slider_bottom_img) : asset('assets/admin/img/noimage.jpg')}}"
                    alt="..." class="img-thumbnail w-100">
                </div>
      ...
      <div class="modal-body">
        <form class="modal-form" id="ajaxForm" action="{{route('admin.slider.store')}}" method="post">
          ...
          <div class="form-group">
            ...
            <p class="text-warning"><small>The higher the serial number is, the later the slider will be shown.</small>
            </p>
          </div>
        </form>
      </div>
