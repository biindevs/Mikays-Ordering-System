            ...
            <div class="row">
              <div class="col-lg-6 offset-lg-3">
                ...
                <div class="form-group">
                    ...
                    <p class="mb-0 text-warning">For multiple addresses, please use a newline to separate them.</p>
                  ...
                  <div class="form-group">
                    ...
                    <p class="mb-0 text-warning">To enter multiple contact numbers, please separate them using a comma (,).</p>
                  ...
                  <div class="form-group">
                    ...
                    <p class="mb-0 text-warning">To enter multiple emails, please separate them using a comma (,).</p>
