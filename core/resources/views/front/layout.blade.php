                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 order-3 order-lg-2">
                        <div class="footer-widget-2 text-left text-sm-center >
                            <a href="
                            {{ route('front.index') }}"><img
                                src="{{ asset('assets/front/img/' . $bs->footer_logo) }}" alt="logo"></a>
                            <ul class="pt-25">
                                @php
                            ...
                            @if (!empty($be->footer_bottom_img))
                                <a class="pt-30" href="javascript:;">
                                    <img class="lazy"
                                        data-src="{{ asset('assets/front/img/' . $be->footer_bottom_img) }}" alt="">
                                </a>
                            @endif
                        </div>
                    </div>
