<div class="cart-sidebar">
   <div id="refreshDiv">
            ...
            <div class="details">
               ...
               <div class="details-footer">
                  <span class="qty-price">
                     ...
                     ''}}<span>{{$item['product_price']}}</span>{{$be->base_currency_symbol_position == 'right' ?
                     $be->base_currency_symbol : ''}}
                     = --}}
                     {{__('Item Total')}}: {{$be->base_currency_symbol_position == 'left' ? $be->base_currency_symbol :
                     ''}}<span>{{$item['total']}}</span>{{$be->base_currency_symbol_position == 'right' ?
                     $be->base_currency_symbol : ''}}
                  </span>
                  <div class="qty">
      ...
      <div class="cart-total">
         ...
         <strong class="total">
            {{$be->base_currency_symbol_position == 'left' ? $be->base_currency_symbol :
            ''}}<span>{{$cartTotal}}</span>{{$be->base_currency_symbol_position == 'right' ? $be->base_currency_symbol :
            ''}}
         </strong>
      </div>
