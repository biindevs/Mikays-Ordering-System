<script>
    ...
    //Remove coupon when the browser is refreshed
        ...
        $.post(
            ...
            function(data) {
                ...
                if (data.status == 'success') {
                    ...
                    $("#coupon-header").text('Applied coupon code: ' + $("input[name='coupon']").val());
                    $("input[name='coupon']").prop('disabled', true);
                    $(".btn.btn-primary.base-btn").hide();
    ...
    $("#remove-coupon-btn").on('click', function() {
        $.post(
            ...
            function(data) {
                if (data.status == 'success') {
                    toastr["success"](data.message);
                    $("#coupon-header").text('{{__('Coupon')}}');
                    $("input[name='coupon']").prop('disabled', false);
                    $(".btn.btn-primary.base-btn").show();
    ...
    $(document).ready(function() {
        ...
        dateToday.setDate(dateToday.getDate() + 2); // add two days
