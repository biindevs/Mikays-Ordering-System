<div class="cart-total" id="orderTotal">
    ...
    <div class="coupon">
        <h4 class="mb-3" id="coupon-header">{{__('Coupon')}}</h4>
        <div class="form-group d-flex">
            <input type="text" class="form-control mr-3" name="coupon" value="" id="coupon-input">
            <button class="btn btn-primary base-btn" type="button" onclick="applyCoupon();">{{__('Apply')}}</button>
            <button class="btn btn-danger base-btn d-none mr-3" type="button" id="remove-coupon-btn">{{__('Remove')}}</button>
        </div>
    </div>
